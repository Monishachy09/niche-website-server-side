...
client.connect(err => {
  const productCollection = client.db("autoDeal").collection("product");
  const adminCollection = client.db("autoDeal").collection("admin");
  const reviewCollection = client.db("autoDeal").collection("review"); 
  const orderCollection = client.db("autoDeal").collection("orders"); 
